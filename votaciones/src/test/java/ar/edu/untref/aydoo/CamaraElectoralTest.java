...
public class CamaraElectoralTest {
    ...
    @Test
    public void votacionPrimariaAbiertasSimultaneasObligatoriasParaPartidoGanadorNacional() {
        ...
        Assert.assertTrue(camaraElectoral.getPartidoNacionalGanador().equals(socialista));
    }
}
